...
const PrFromNewbies: React.FC = () => {
  return (
    <div className="article-content">
      ...
      <DetailsSummary
        anchor="explain-render-bar-colors"
        tag="полоса рендеринга, render bar color, индикатор производительности"
        title="Что означают красные, жёлтые и зелёные полосы на таймлайне?"
      >
        <p>
          В <mark className="app">Adobe Premiere Pro</mark> уже давно реализована
          индикация производительности таймлайна. Цветная полоса над клипами показывает,
          сможет ли участок воспроизводиться в реальном времени без предварительного
          рендера.
        </p>
        <Addition type="info">
          Цветные индикаторы не являются точным показателем производительности проекта.
          Например, жёлтые и красные участки не обязательно будут тормозить. Это лишь
          оценка <mark className="app">Adobe Premiere</mark> на основе параметров проекта
          и доступных ресурсов компьютера.
        </Addition>
        <ul>
          <li>
            <p>
              Красные участки означают, что для их плавного воспроизведения при
              предпросмотре, скорее всего, потребуется предварительный рендер. Обычно это
              происходит из-за применения ресурсоёмких эффектов, отсутствия аппаратного
              ускорения или использования тяжёлых исходников.
            </p>
            <Addition type="info">
              Для создания предварительного рендера на красных участках — отметьте точку
              входа и выхода на таймлайне с помощью клавиш <mark className="key">I</mark>{" "}
              и <mark className="key">O</mark>, а затем выберите{" "}
              <mark className="select">«Sequence» → «Render Effects In to Out»</mark> или
              нажмите на <mark className="key">Enter</mark>.
            </Addition>
          </li>
          <li>
            <p>
              Жёлтые участки означают, что их можно воспроизвести при предпросмотре без
              создания предварительного рендера, однако плавность зависит от
              производительности вашего устройства. Если доступных ресурсов недостаточно,
              могут появляться пропуски кадров.
            </p>
            <Addition type="info">
              Для создания предварительного рендера на красных и жёлтых участках —
              отметьте точку входа и выхода на таймлайне с помощью клавиш{" "}
              <mark className="key">I</mark> и <mark className="key">O</mark>, а затем
              выберите <mark className="select">«Sequence» → «Render In to Out»</mark>.
            </Addition>
          </li>
          <li>
            Зелёные участки означают, что для них уже создан предварительный рендер. Такие
            участки обычно воспроизводятся стабильнее и плавнее, так как{" "}
            <mark className="app">Adobe Premiere</mark> не рассчитывает их заново во время
            предпросмотра.
          </li>
        </ul>
        <ArticleMedia

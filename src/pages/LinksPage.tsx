      ...
      <PageTransition className="main">
        ...
        <div className="links">
          ...
          <div className="links-grid">
            ...
            <FolderCard name="Вакансии и работа">
                ...
                <div className={modalStyles["modal"]}>
                  ...
                  <div className={modalStyles["modal-content"]}>
                    <p>
                      ...
                      вы можете столкнуться с недобросовестным заказчиком или попасть в
                      ловко организованную схему мошенничества.
                    </p>
                    <Addition type="danger">
                      <ul>
                        <li>
                        ...
                        <li>
                          ...
                          Насторожитесь, если в аккаунте{" "}
                          <mark className="app">Telegram</mark> или другом мессенджере
                          несколько одинаковых фото, загруженных в один день — это частый
                          признак нового или взломанного профиля, созданного для
                          выманивания денег.
                        </li>
                      </ul>
                    </Addition>
